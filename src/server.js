...
app.post('/update', async (req, res) => {
    await docker.updateService(req.body.service_id, req.body.service_name, req.body.service_version, req.body.service_image, req.body.service_new_image_version);
